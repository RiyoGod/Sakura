...
async def get_thumb(videoid):
    ...
    title_font = ImageFont.truetype("AnonXMusic/assets/semibold.ttf", 28)
    channel_name_font = ImageFont.truetype("AnonXMusic/assets/semibold.ttf", 20)
    duration_font = ImageFont.truetype("AnonXMusic/assets/semibold.ttf", 18)


    # Load your image
    my_image = Image.open("AnonXMusic/assets/bg.png").convert("RGBA")
