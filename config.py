...
API_KEY = getenv("API_KEY", None) # youtube song api key, get it from https://t.me/xDiviine

UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/StormBeatz/LevyMusic",
)
...
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/GrayBotSupport")

# Set this to True if you want the assistant to automatically leave chats after an interval
AUTO_LEAVING_ASSISTANT = bool(getenv("AUTO_LEAVING_ASSISTANT", False))

# make your bots privacy from telegra.ph and put your url here 
PRIVACY_LINK = getenv("PRIVACY_LINK", "https://telegra.ph/Privacy-Policy-for-LevyMusic-08-14")
